    ...
    <body>
                ...
                <div class="row justify-content-center">
                    <div class="col-xl-6">
                        <div class="text-center text-white">
                            <!-- Page heading-->
                            <h1 class="mb-5">Solusi Internet Banking Termudah dan Paling Family Friendly Buat Para Pemula dan Newbie User!</h1>
                ...
                <div class="row">
                    <div class="col-lg-4">
                        <div class="features-icons-item mx-auto mb-5 mb-lg-0 mb-lg-3">
                            ...
                            <h3>Meminjam</h3>
                            <p class="lead mb-0">Untuk menghitung dan mengkalculasi bisa klik button Calkulator pinjaman berikut. <a class="btn btn-primary" href="{{ url('/calculator') }}">Calculator</a></p>
                        </div>
                    </div>
                    <div class="col-lg-4">
                        <div class="features-icons-item mx-auto mb-5 mb-lg-0 mb-lg-3">
        ...
        <section class="showcase">
            <div class="container-fluid p-0">
                <div class="row g-0">
                    <div class="col-lg-6 order-lg-2 text-white showcase-img" style="background-image: url('{{ asset('import_home/assets/img/bg-showcase-1.jpg') }}')"></div>
                ...
                <div class="row g-0">
                    <div class="col-lg-6 text-white showcase-img" style="background-image: url('{{ asset('import_home/assets/img/bg-showcase-2.jpg') }}')"></div>
                ...
                <div class="row g-0">
                    <div class="col-lg-6 order-lg-2 text-white showcase-img" style="background-image: url('{{ asset('import_home/assets/img/bg-showcase-3.jpg') }}')"></div>
                    <div class="col-lg-6 order-lg-1 my-auto showcase-text">
                ...
                <div class="row">
                    <div class="col-lg-4">
                        <div class="testimonial-item mx-auto mb-5 mb-lg-0">
                            <img class="img-fluid rounded-circle mb-3" src="{{ asset('import_home/assets/img/testimonials-1.jpg') }}" alt="..." />
                            <h5>Margaret E.</h5>
                    ...
                    <div class="col-lg-4">
                        <div class="testimonial-item mx-auto mb-5 mb-lg-0">
                            <img class="img-fluid rounded-circle mb-3" src="{{ asset('import_home/assets/img/testimonials-2.jpg') }}" alt="..." />
                            <h5>Fred S.</h5>
                    ...
                    <div class="col-lg-4">
                        <div class="testimonial-item mx-auto mb-5 mb-lg-0">
                            <img class="img-fluid rounded-circle mb-3" src="{{ asset('import_home/assets/img/testimonials-3.jpg') }}" alt="..." />
                            <h5>Sarah W.</h5>
